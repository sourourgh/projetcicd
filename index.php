...
?>
                        ...
                        <a class="btn hvr-hover" href="produit_details.php?id=<?php echo $id_c; ?>"><?php echo $libelle_c?></a>
                    </div>
                    <div class="shop-cat-box">
                    <?php
...
$sql_c = "select * from categorie where libelle_c='shoes'";
                    ...
                    //4- exécution de la requête
	                    ...
	                    $libelle_p 	= $array['libelle_p'];
                         ...
                         $id_c      = $array['id_c'];
                            ...
                            $sql_c = "select * from categorie where id_c=$id_c";
                ...
                <div class="col-lg-3 col-md-6 special-grid best-seller">
                    <div class="products-single fix">
                        <div class="box-img-hover">
                            ...
                            <img src="./Admin/uploads/<?php echo $image_p; ?>" style="width:250px;height:350px;" class="img-fluid" alt="Image">
                            <div class="mask-icon">

                                <a class="cart" href="add-card.php?id=<?php echo $id_p; ?>">Add to Cart</a>
                            </div>
                        </div>
                        <div class="why-text">
                            <h4><?php echo $libelle_p; ?></h4>
                            <h5> $<?php echo $prix; ?></h5>
                        </div>
                    </div>
                </div>
